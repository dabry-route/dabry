    ...
    def __init__(self,
        ...
        if sum([max_time is None, dt is None, max_steps is None]) >= 2:
            if max_steps is not None:
                ...
                dt = 1.5 / mp.aero.v_min / max_steps
        ...
        if dt is not None:
            ...
            if mode == 0:
                self.dt = -.005 / mp.srf_max
            else:
                self.dt = -.005 / mp.aero.v_minp
        ...
        if cost_ceil is None and mode == 1:
            cost_ceil = self.mp.aero.power(self.v_max) / self.v_max
        ...
        self.alpha_value = 1 / self.alpha_param
