...
if __name__ == '__main__':
    ...
    pb.set_case_dir(os.path.join(output_dir, pb.name))
    solver.save_results(rescale=True)
    pb.save_traj(traj_ortho, 'orthodromic', rescale=True)
    pb.save_traj(traj_radial, 'radial', rescale=True)
